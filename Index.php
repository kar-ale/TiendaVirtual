...
<style type="text/css">
   body {
      background-image:url(asset/imgv/saku.jpg);
      font: 10pt Verdana, Geneva, Arial, Helvetica, sans-serif;
   }
   #inputs {
      border:5px inset rgb(255, 153, 231);
      width: 60px;
      background:rgb(252, 148, 236);
      text-align : center;
   }
   #boton  {
      background: rgb(196, 102, 204) border:1px outset rgb(94,71,159);
      width:80px;
...
<meta charset="utf-8">
  ...
  <a href="controlador/welcome.php"><img src="asset/imgv/usuario.png" width="50"height="50" ></a><a href="vista/pedido.html"><img src="asset/imgv/carrito.png" width="50"height="50" align="right"></a>
  <h1 align="center" style="color:aliceblue;">BIENVENIDO A NOCHE ESTRELLADA </h1>
 ...
 <table  align="center"  width="1000"border="5" cellspacing="2" cellpadding="5" style="font: 10pt Verdana, Geneva, Arial, Helvetica, sans-serif;" background = "img/rosa2.jpg">
   <thead> 
    <tr>
